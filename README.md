...
-   [ ] 검색 자동완성 기능
    ...
    -   [x] 그리고 삭제 기능 가능하도록
        -   [ ] 삭제했을 때 포커싱 중이던 아이템에 따라 화면 변경
            -   [ ] 포커싱 중이던 아이템 앞에 있는 아이템을 삭제했을 경우 포커싱 그대로 유지
            -   [ ] 포커싱 중이던 아이템 삭제하면 검색창의 글자도 없어지고 모든 포커싱이 사라지고 초기화됨
            -   [ ] 포커싱 중이던 아이템 뒤에 있는 아이템을 삭제했을 경우 포커싱 그대로 유지
